...
<body>
    <div id="logreg-forms">
        <form class="form-signin">
            ...
            <input type="email" id="inputEmail" class="form-control" placeholder="Mon adresse email" required="" autofocus="">
            ...
            <form action="/signup/" class="form-signup">
                ...
                <input type="text" id="user-name" class="form-control" placeholder="Prénom NOM" required="" autofocus="">
                <input type="email" id="user-email" class="form-control" placeholder="Mon adresse email" required autofocus="">
                <input type="password" id="user-pass" class="form-control" placeholder="Mot de Passe" required autofocus="">
                <input type="password" id="user-repeatpass" class="form-control" placeholder="Confirmer Mot de Passe" required autofocus="">
...
})g" target="_blank" style="color:black">Peut-on enlever cette partie du code ? ou est-ce que c'est un traceur qui appelle aussi les fonctionnalités du formulaire ?</a>
    </p>
